...
<script type="text/javascript">
   ...
   function joincheck(f){
      var joinid = f.id.value;
      if(f.id.value == ""){
         alert("회원님의 ID를 입력해주세요!")
         return false;
      }
      $.ajax({
            type : "GET",
            url : "../ajax/idcheck.shop",
            data : {
               "id" : joinid
            },
...
<body>
   ...
   <div class="container-login100"
      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30"
         style="width: 600px;">
         <form class="login100-form validate-form" action="joinpass.shop" method="post" name="f">
            <span class="login100-form-title p-b-37" id="sp"> 회원님의 ID를 입력해주세요 </span>
            ...
            <div id="d2">
               ...
               <ul class="dots mt10"><li><font style="color: #b4b4b4;">ㆍ ID는 등록 후에 변경하실 수 없습니다.</font></li></ul>
            </div>
            <br>
