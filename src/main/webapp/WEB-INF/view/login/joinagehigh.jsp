...
<script type="text/javascript">
	...
	function joincheck(){
		if(f.agehigh.value == ""){
			alert("회원님이 바라는 상대방의 나이를 선택해주세요!(상한)")
			return false;
		}
		return true;
	}
...
<body>
	...
	<div class="container-login100"
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30"
			style="width: 600px;">
			<form class="login100-form validate-form" action="joinagelow.shop"
				...
				<span class="login100-form-title p-b-37" id="sp"> 상대방의 희망나이를 알려주세요.<div style="float: right;" id="d2">(상한)</div></span>
				<br>
