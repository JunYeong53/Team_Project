...
<body>
   ...
   <div class="container-login100" style="background-image: url('images/loginimg.jpg');">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
         <form class="login100-form validate-form" action="login.shop" method="post" name="f" onsubmit="return joincheck()">
            ...
            <div class="wrap-input100 input m-b-20" data-validate="Enter username or email">
            ...
            <div class="wrap-input100 input m-b-25" data-validate = "Enter password">
            ...
            <div style="text-align:center;">
               <a href="idsearch.shop" style="padding-right: 15%;" class="txt2">ID찾기</a>
               <a href="passsearch.shop" class="txt2">PW찾기</a>
            </div>

            <div class="text-center p-t-57 p-b-20"  style="padding-top: 15px;">
               <span class="txt1">
                  살려줘...
               </span>
            </div>
            ...
            <div class="text-center">
               <a href="joinid.shop" class="txt2 hov1">
                  Sign Up
               </a>
            </div>
         </form>
