		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30"
			...
			<form class="login100-form validate-form" action="joingender.shop" method="post" name="f" onsubmit="return joincheck()">
				...
				<div class="inputy-item" id="d1">
					<input type="password" name="password" style="font-size: 1.5rem; color: #575757; border: 1px solid #d8d7dc; border-radius: 8px; padding: 8px; box-sizing: border-box; width: 100%;">	
				</div>
				<br>
				<div id="d2">
					<div class="fnt-b"><font style="color: #b4b4b4;">주의해 주세요.</font></div>
					<ul class="dots mt10"><li><font style="color: #b4b4b4;">ㆍ 비밀번호는 등록 후에 변경하실 수 있습니다.</font></li></ul>
				</div>
				<br>
