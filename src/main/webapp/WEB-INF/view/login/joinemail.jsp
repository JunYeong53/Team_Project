...
<body>
   ...
   <div class="container-login100"
      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30"
         style="width: 600px;">
         <form class="login100-form validate-form" action="joinaddr.shop" method="post" name="f" onsubmit="return joincheck()">
            <input type="hidden" name="id" value="${user.id}">
            <input type="hidden" name="password" value="${user.password}">
            <input type="hidden" name="gender" value="${user.gender}">
            <input type="hidden" name="phone" value="${user.phone}">
            <input type="hidden" name="birth" value="${birth}">
            <span class="login100-form-title p-b-37" id="sp"> 회원님의 이메일을 입력해주세요 </span>
            ...
            <div id="d2">
               ...
               <ul class="dots mt10"><li><font style="color: #b4b4b4;">ㆍ 이메일은 등록 후에 변경하실 수 없습니다.</font></li></ul>
            </div>
            <br>
